...
public class RJScreens {
    public static final ExtendedScreenHandlerType<PasswordScreenHandler, SafePasswordPacketS2C> PASSWORD_SCREEN = register("password_screen", new ExtendedScreenHandlerType<>((syncId, playerInventory, safePasswordPacket) -> {
