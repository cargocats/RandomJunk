...
public class JobAppEntityModel extends EntityModel<JobAppEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("root", ModelPartBuilder.create().uv(0, 0).cuboid(-32.0F, -128.0F, 0.0F, 64.0F, 128.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 24.0F, 0.0F));
