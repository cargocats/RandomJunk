...
public class RJTranslationProvider extends FabricLanguageProvider {
    public RJTranslationProvider(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
